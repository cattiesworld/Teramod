...
const Credits = () => (
    <main className={styles.main}>
        ...
        <section>
            ...
            <UserList users={UserData.sb3ullRequestDevelopers} />
            <p><i>The list order is randomized on each refresh.</i></p>
            <p>
        ...
        <section>
            ...
            <p>
                ...
                <ul>
                    ...
                    <li><a href="https://discord.gg/mVHKXvUgsn">User-submissions from the TeraMod Discord Server</a></li>
                    <li>The TeraMod Developers</li>
                </ul>
